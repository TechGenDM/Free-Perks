...
export function Footer() {
  return (
    <footer className="w-full bg-[#05070a] border-t border-white/[0.06] text-slate-400 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 to-purple-500 text-white font-mono text-xs font-bold shadow-md shadow-indigo-600/20">
                FP
              </div>
